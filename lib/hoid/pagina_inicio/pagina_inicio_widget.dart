                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed('InicioRegistro');
                                  },
                                  text: 'Sign in',
                              ...
                              Align(
                                alignment: AlignmentDirectional(0.92, 0.02),
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed('InicioRegistro');
                                  },
                            ...
                            child: CarouselSlider(
                              items: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: Image.asset(
                                    'assets/images/Screenshot_2024-05-08_at_6.22.20_p.m..png',
                                    width: 300.0,
                                    height: 285.0,
                                    fit: BoxFit.cover,
                                  ),
                                ...
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: Image.asset(
                                    'assets/images/World_Hottest_Tour.png',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                                ...
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: Image.asset(
                                    'assets/images/ac031d5641fc7b173ffd6a0bfbdea361ece95508.jpg',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                                ...
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(8.0),
                                  child: Image.asset(
                                    'assets/images/ab67706c0000da84c5621b73b1183d4c47b5daab.jpeg',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
                                            ...
                                            Padding(
                                              ...
                                              child: ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(8.0),
                                                child: Image.asset(
                                                  'assets/images/Screenshot_2024-05-08_at_6.46.17_p.m..png',
                                                  width: 300.0,
                                                  height: 200.0,
                                                  fit: BoxFit.cover,
                                                ),
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            30.0, 20.0, 0.0, 30.0),
                        child: Text(
                          'By continuing to use this page, you agree to be bound by our Terms of Use.',
                          style:
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Align(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    30.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  'Purchase Policy     |    Privacy Policy    |   Cookie Policy    |   Manage my cookies',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Manrope',
                            ...
                            Text(
                              '© 2023-2024 Byron. All rights reserved.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Manrope',
